...
public class DiseaseCountFacade {
   ...
   public Object getDiseaseShCount(){
        IndianDiseaseStat shDisease = indiaDiseaseStat.GetInstance(SourceType.DiseaseSh);
        return shDisease.GetActiveCount();
   }
    ...
    public Object getJohnHopkinCount(){
        IndianDiseaseStat shDisease = indiaDiseaseStat.GetInstance(SourceType.JohnHopkins);
        return shDisease.GetActiveCount();
    }
